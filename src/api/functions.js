...
// Simple function exports (no special characters)
...
// Functions with slashes in names - use bracket notation
...
export const syncReplies = base44.functions['gmail/syncReplies']; // Alias for backward compatibility
...
// Convenience: Re-export the base44 client for direct access if needed
export { base44 };
