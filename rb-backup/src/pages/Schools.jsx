...
import { Target, Search, Star, CheckCircle, MapPin, Trash2, Bot, Sparkles, Lock, Info } from "lucide-react";
...
const getFormattedSchoolName = (schoolName) => {
  const schoolNameMappings = {
    ...
    "Yale University": "Yale Bulldogs (University of Yale)",
    ...
    <TooltipProvider>
      <div className="min-h-screen bg-gradient-to-br from-slate-50 to-blue-50 p-6">
        <div className="max-w-7xl mx-auto space-y-6">
          {/* Enhanced Header */}
          <div className="flex items-center gap-4 bg-white/80 backdrop-blur-sm rounded-2xl p-6 shadow-lg border border-slate-200">
            <div className="w-16 h-16 bg-gradient-to-r from-blue-600 to-indigo-600 rounded-2xl flex items-center justify-center shadow-lg">
              <Target className="w-8 h-8 text-white" />
            </div>
            <div>
              <h1 className="text-4xl font-bold text-slate-900">Target Schools</h1>
              <p className="text-slate-600 text-lg">Build your list of target programs and track your progress</p>
            </div>
          </div>
          ...
          {/* Filters */}
          <Card className="mb-8 school-search">
              <CardHeader>
