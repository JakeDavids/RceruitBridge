...
export default function CoachContacts() {
  ...
  const [showAddCoachDialog, setShowAddCoachDialog] = useState(false); // Renamed from isAddManualOpen
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 to-blue-50 p-6">
      <div className="max-w-7xl mx-auto space-y-6">
        {/* Enhanced Header */}
        <div className="flex items-center justify-between bg-white/80 backdrop-blur-sm rounded-2xl p-6 shadow-lg border border-slate-200">
          <div className="flex items-center gap-4">
            <div className="w-16 h-16 bg-gradient-to-r from-blue-600 to-indigo-600 rounded-2xl flex items-center justify-center shadow-lg">
              <Users className="w-8 h-8 text-white" />
            </div>
            <div>
              <h1 className="text-4xl font-bold text-slate-900">Coach Contacts</h1>
              <p className="text-slate-600 text-lg">Track coaches from your target schools</p>
            </div>
          </div>
        ...
        <div className="grid lg:grid-cols-5 gap-8">
            ...
            <div className="lg:col-span-2 space-y-8">
                <Card>
                    <CardHeader>
                        <CardTitle>Import Coach Contacts</CardTitle>
                        <CardDescription>Quickly add multiple coaches from a staff directory.</CardDescription>
                    </CardHeader>
