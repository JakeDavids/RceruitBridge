...
export default function BillingPortal() {
  ...
  const handleCancelSubscription = async () => {
    ...
    const selectedReason = reasons[parseInt(reasonIndex) - 1] || "Other";
    
    const additionalComments = prompt(
      "Any additional feedback? (Optional)\n\nThis helps us improve RecruitBridge:"
    );

    const confirmCancel = confirm(
      `Are you sure you want to cancel your ${user?.plan} plan?\n\n` +
    ...
    try {
      const response = await base44.functions.invoke('subscription/cancel', {
        reason: selectedReason,
        reasonText: additionalComments,
      ...
      if (response.data?.ok) {
        alert(
          ...
          "We've received your cancellation request and will process your refund within 24-48 hours.\n\n" +
          "Thank you for being part of RecruitBridge. We hope to see you again!"
        );
      ...
      alert(
        ...
        "Please email us directly at realrecruitbridge@gmail.com\n\n" +
        "We'll process your cancellation immediately."
      );
    }
